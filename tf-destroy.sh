...
echo "Don't forget that this will not delete the 250GB Volume attached to Jenkins (to protect your prod data ;) so make sure to head to https://us-east-1.console.aws.amazon.com/ec2/v2/home?region=us-east-1#Volumes:sort=desc:createTime in order to delete it"
